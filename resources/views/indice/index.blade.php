            ...
            <table id="datatable" class="table table-striped dataTable" data-toggle="data-table"
                ...
                <thead>
                    <tr>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;"> Montant nuit
                        </th>
                         <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;"> Montant repas
                        </th>
                ...
                <tbody>
                    ...
                    <tr class="odd">
                        ...
                        <td>{{$indice->code}}</td>
                        <td>{{$indice->montantNuite}}</td>
                        <td>{{$indice->montantRepas}}</td>
                        <td>
