        ...
        <form action="{{ route('validateMission', $detailMission->id) }}" method="POST">
            ...
            <div class="row mb-4">
                ...
                <div class="col-lg-6">
                    ...
                    <input class="form-control" type="text" name="refOm" id="refOm" required>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-lg-6">
                    ...
                    <select class="form-control form-select" name="moyenDeDeplacement" id="moyenDeDeplacement" required>
                ...
                <div class="col-lg-6 mb-4" id="vehicule_select"
                    ...
                    <select class="form-control form-select" name="vehicule_id" id="vehicule_id" required>
                ...
                <div class="col-lg-6">
                    ...
                    <select class="form-control form-select" name="lieuMission_id" id="lieuMission_id" required>
            ...
            <div class="text-end">
                <button class="btn btn-primary" type="submit">Valider personnel</button>
            </div>
