    ...
    <div class="card-body container">
        ...
        <form action="{{ route('validateMission', $detailMission->id) }}" method="POST">
            ...
            <div class="text-end row">
                <div class="col-lg-9">
                    <button class="btn btn-danger" type="submit" name="action" value="invalidate">Annuler</button>
                </div>
                <div class="col-lg-3">
