    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <div class="header-title">
                <h4 class="card-title">Liste des responsables d'intervention</h4>
            </div>
            <div class="mb-2">
                <a type="button" class="btn btn-primary" href="{{ route('show-responsable-intervention') }}">
            ...
            <table id="datatable" class="table table-striped dataTable" data-toggle="data-table"
                ...
                <tbody>
                    ...
                    <tr class="odd">
                        ...
                        <td>{{$responsableintervention->nomResponsable}}</td>
                        <td>
                            <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-original-title="Modifier" aria-label="Modifier" data-bs-original-title="Modifier" href="{{ route('consulter-responsable-intervention', $responsableintervention->id) }}">
                            ...
                            <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                href="{{ route('delete-responsable-intervention', $responsableintervention->id) }}">
                                <span class="btn-inner">
                                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
