...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <div class="mb-2">
                <a type="button" class="btn btn-primary" href="{{ route('show-marque') }}">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;">Nom de la
                            marque
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                    ...
                    <tr class="odd">
                        ...
                        <td>
                            <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-original-title="Modifier" aria-label="Modifier" data-bs-original-title="Modifier" href="{{ route('consulter-marque', $marque->id) }}">
                            ...
                            <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                href="{{ route('delete-marque', $marque->id) }}">
                                <span class="btn-inner">
                                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
