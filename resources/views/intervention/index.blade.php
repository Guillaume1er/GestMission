            ...
            <table id="datatable" class="table table-striped dataTable" data-toggle="data-table"
                ...
                <thead>
                    <tr>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;"> Objet
                            intervention
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;">
                        ...
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;"> Panne
                            survenues
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;">
                        ...
                        <tr class="odd">
                            ...
                            <td>
                                @if ($intervention->validationIntervention)
                                    <!-- Bouton désactivé et grisé -->
                                    <a class="btn btn-sm btn-icon btn-secondary" data-bs-toggle="tooltip"
                                        data-bs-placement="top" data-original-title="Non modifiable"
                                        aria-label="Non modifiable" data-bs-original-title="Non modifiable"
                                ...
                                @else
                                    ...
                                    <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip"
                                        ...
                                        href="{{ route('consulter-intervention', $intervention->id) }}">
                                        <span class="btn-inner">
                                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <!-- Icône SVG inchangée -->
