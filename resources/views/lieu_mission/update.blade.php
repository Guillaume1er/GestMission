...
<div class="card-body container">
    ...
    <form method="POST" action="{{ route('update-lieu-mission', $lieumission->id) }}">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <select class="form-select" required name="departement_id" id="departement_id" {{ $lieumission->departement_id == $lieumission->id ? 'selected' : '' }}>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="mb-3">
                    <input class="form-check-input" type="checkbox" id="nuite" value="1" name="nuite" {{$lieumission->nuite ? 'checked':''}}>
