...
<div class="mb-4 mt-4 ms-4">
    ...
    <div class="card-body">
        <div class="header-title">
            <h4 class="card-title">Modifier le type de véhicule</h4>
        </div> <br>
        ...
        <form method="POST" action="{{ route('update-type-vehicule', $typevehicule->id) }}">
            @csrf
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-3">
                        <label for="typeVehicule" class="form-label">Type de véhicule</label>
                        <input type="text" required class="form-control" value="{{ $typevehicule->typeVehicule }}" name="typeVehicule">
                    </div>
                </div>
