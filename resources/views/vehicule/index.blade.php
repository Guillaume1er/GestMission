...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <div class="">
                <a type="button" class="btn btn-primary" href="{{ route('show-vehicule') }}">
            ...
            <table id="datatable" class="table table-striped dataTable" data-toggle="data-table"
                ...
                <thead>
                    <tr>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;"> Responsable
                            véhicule
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                        ...
                        <tr class="odd">
                            ...
                            <td>
                                <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip"
                                    ...
                                    href="{{ route('consulter-vehicule', $vehicule->id) }}">
                                ...
                                <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip"
                                    ...
                                    href="{{ route('delete-vehicule', $vehicule->id) }}">
                                    <span class="btn-inner">
                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
