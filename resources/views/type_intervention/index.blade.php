    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <div class="header-title">
                <h4 class="card-title">Liste des types d'intervention</h4>
            </div>
            <div class="">
                <a type="button" class="btn btn-primary" href="{{ route('show-type-intervention') }}">
            ...
            <table id="datatable" class="table table-striped dataTable" data-toggle="data-table"
                ...
                <thead>
                    <tr>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;"> Type d'intervention
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;"> Description
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                ...
                <tbody>
                    ...
                    <tr class="odd">
                        ...
                        <td>{{$typeintervention->typeIntervention}}</td>
                        <td>{{$typeintervention->description}}</td>
                        <td>
                            <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-original-title="Modifier" aria-label="Modifier" data-bs-original-title="Modifier" href="{{ route('consulter-type-intervention', $typeintervention->id) }}">
                            ...
                            <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                href="{{ route('delete-type-intervention', $typeintervention->id) }}">
                                <span class="btn-inner">
                                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
