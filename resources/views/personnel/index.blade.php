...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <div class="">
                <a type="button" class="btn btn-primary" href="{{ route('show-personnel') }}">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;"> Nom et
                            prénom
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;"> Matricule
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;"> Civilité
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;">Contact
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;"> Email
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;">Adresse
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;"> Numéro Ifu
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;"> Rang
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Position: activate to sort column ascending" style="width: 388.266px;"> Indice
                        </th>
                ...
                <tbody>
                    @foreach ($personnels as $personnel)
                        <tr class="odd">
                            ...
                            <td>{{ $personnel->numeroMatricule }}</td>
                            <td>{{ $personnel->civilite }}</td>
                            <td>{{ $personnel->contact }}</td>
                            <td>{{ $personnel->email }}</td>
                            <td>{{ $personnel->adresse }}</td>
                            <td>{{ $personnel->numIfu }}</td>
                            <td>{{ $personnel->nomrang->nomrang }}</td>
                            <td>{{ $personnel->code->code }}</td>
                            ...
                            <td>
                                <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip"
                                    ...
                                    href="{{ route('consulter-personnel', $personnel->id) }}">
                                ...
                                <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip"
                                    ...
                                    href="{{ route('delete-personnel', $personnel->id) }}">
                                    <span class="btn-inner">
                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
